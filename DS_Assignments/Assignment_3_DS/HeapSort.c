...
/*Time Complexity:
It is nlogn in three cases because the height of a complete binary tree having n elements is logn.

The time complexity in all three cases is the same as merge sort.
